...
const messages = {
  en: {
    ...
    "pwa.installHintPrefix": "Use the browser menu or share button, then choose",
    "pwa.addToHomeScreen": "Add to Home Screen",
    "pwa.installHintSuffix": ".",
    "pwa.dismissInstallHint": "Dismiss install hint",
    "pwa.iosShareMenu": "iPhone Safari needs the share menu",
    ...
    "rating.companions": "Who was there",
    "rating.companionsPlaceholder": "Friends, family, date, teammates...",
  ...
  zh: {
    ...
    "nav.todo": "待吃",
    "pwa.install": "安装应用",
    "pwa.installHintPrefix": "请打开浏览器菜单或分享按钮，然后选择",
    "pwa.addToHomeScreen": "添加到主屏幕",
    "pwa.installHintSuffix": "。",
    "pwa.dismissInstallHint": "关闭安装提示",
    "pwa.iosShareMenu": "iPhone Safari 需要使用分享菜单",
    ...
    "rating.companions": "和谁一起",
    "rating.companionsPlaceholder": "朋友、家人、约会、同事...",
    "rating.spend": "人均消费",
    "rating.optional": "可选",
    "rating.tags": "标签",
  ...
  fr: {
    ...
    "pwa.installHintPrefix": "Utilisez le menu du navigateur ou le bouton de partage, puis choisissez",
    "pwa.addToHomeScreen": "Ajouter à l'écran d'accueil",
    "pwa.installHintSuffix": ".",
    "pwa.dismissInstallHint": "Fermer l'aide d'installation",
    "pwa.iosShareMenu": "iPhone Safari utilise le menu de partage",
    ...
    "rating.companions": "Avec qui",
    "rating.companionsPlaceholder": "Amis, famille, rendez-vous, collègues...",
