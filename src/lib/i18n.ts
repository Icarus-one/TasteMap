...
const messages = {
  en: {
    ...
    "settings.metrics": "Growth metrics",
    ...
    "auth.forgotPassword.subtitle":
      "Enter your email and TasteMap will send a secure password reset link.",
    ...
    "auth.resetPassword.subtitle":
      "Use the recovery link from your email, then set a new password for this account.",
    "auth.newPassword": "New password",
    "auth.confirmPassword": "Confirm password",
    "auth.passwordMismatch": "The two passwords do not match.",
    "auth.updatePassword": "Update password",
    "auth.passwordUpdated": "Password updated. You can continue to TasteMap.",
  ...
  zh: {
    ...
    "auth.forgotPassword.title": "找回密码",
    "auth.forgotPassword.subtitle": "输入邮箱，TasteMap 会发送一封安全的密码重设邮件。",
    "auth.sendResetLink": "发送重设链接",
    "auth.resetEmailSent": "请查看邮箱中的密码重设链接。",
    "auth.backToSignIn": "返回登录",
    "auth.resetPassword.title": "设置新密码",
    "auth.resetPassword.subtitle": "通过邮箱里的恢复链接进入后，为这个账号设置一个新密码。",
    "auth.newPassword": "新密码",
    "auth.confirmPassword": "确认密码",
    "auth.passwordMismatch": "两次输入的密码不一致。",
    "auth.updatePassword": "更新密码",
    "auth.passwordUpdated": "密码已更新。可以继续进入 TasteMap。",
  ...
  fr: {
    ...
    "settings.metrics": "Indicateurs de croissance",
    ...
    "auth.rememberEmail": "Mémoriser l'e-mail",
    "auth.forgotPassword": "Mot de passe oublié ?",
    "auth.forgotPassword.title": "Réinitialiser le mot de passe",
    "auth.forgotPassword.subtitle":
      "Saisissez votre e-mail et TasteMap vous enverra un lien sécurisé.",
    "auth.sendResetLink": "Envoyer le lien",
    "auth.resetEmailSent": "Consultez votre e-mail pour le lien de réinitialisation.",
    "auth.backToSignIn": "Retour à la connexion",
    "auth.resetPassword.title": "Choisir un nouveau mot de passe",
    "auth.resetPassword.subtitle":
      "Utilisez le lien reçu par e-mail, puis définissez un nouveau mot de passe.",
    ...
    "auth.passwordUpdated": "Mot de passe mis à jour. Vous pouvez continuer vers TasteMap.",
